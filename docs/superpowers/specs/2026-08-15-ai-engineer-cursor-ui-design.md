...
## Non-goals (original 2026-08-15 UI slice)

- `@` mentions / file attachments / Agent-vs-Ask mode pills *(superseded for product roadmap 2026-08-25 — see context-ingest + interaction-modes specs; not implemented in the 08-15 UI slice)*
