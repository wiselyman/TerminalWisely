...
fn apply_macos_window_effects(window: &tauri::WebviewWindow) -> tauri::Result<()> {
    ...
    // buttons down. Re-apply after effects settle so lights center in our bar
    // (--chrome-titlebar-height on macOS is 34px; native container uses +2px).
    const X: f64 = 14.0;
...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::reorder_saved_connections,
            ...
            commands::ai_chat_cache_remote_media,
            commands::ai_chat_resolve_media,
            commands::ai_chat_history_load,
            commands::ai_chat_history_load_scope,
            commands::ai_chat_history_save_scope,
            commands::ai_chat_history_save_all,
            commands::ai_chat_history_import_localstorage,
            commands::ai_chat_history_mark_migrated,
            ...
            commands::k8s_update_ssh_binding_session,
            ...
            commands::k8s_cordon_node,
            commands::k8s_uncordon_node,
            commands::k8s_drain_node,
            commands::k8s_node_shell_command,
            commands::k8s_node_shell_start,
            ...
            commands::k8s_list_crd_catalog,
            commands::k8s_list_applications,
            commands::k8s_helm_list_charts,
            commands::k8s_helm_list_repos,
            commands::k8s_helm_add_repo,
            commands::k8s_helm_chart_values,
            commands::k8s_helm_install,
            commands::k8s_helm_upgrade,
            commands::k8s_helm_rollback,
            commands::k8s_helm_uninstall,
            commands::k8s_rollout_restart,
            ...
            commands::k8s_kubectl_cluster_shell_start,
