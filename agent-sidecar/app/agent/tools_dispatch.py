...
TOOL_HANDLER_METHODS: dict[str, str] = {
    ...
    TOOL_IMAGE_GENERATE: "_image_generate",
    ...
    TOOL_HOST_MEMORY_GET: "_host_memory_get",
    TOOL_HOST_MEMORY_PUT: "_host_memory_put",
    TOOL_USER_MEMORY_GET: "_user_memory_get",
    TOOL_USER_MEMORY_PUT: "_user_memory_put",
    TOOL_SKILL_SAVE: "_skill_save",
