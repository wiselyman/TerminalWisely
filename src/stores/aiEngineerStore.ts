...
type AiEngineerState = {
  ...
  /** Inline Agent platform panel (MCP / skills / memory / eval). */
  ...
  setPlatformOpen: (v: boolean) => void;
  togglePlatformView: () => void;
  openPlatformView: () => void;
...
export const useAiEngineerStore = create<AiEngineerState>((set, get) => ({
  ...
  setPlatformOpen: (v) => set({ platformOpen: v }),
  togglePlatformView: () => set((s) => ({ platformOpen: !s.platformOpen })),
  openPlatformView: () => set({ platformOpen: true }),
  openPlatformSettings: () =>
    set({ settingsOpen: true, settingsViewHint: "platform", platformOpen: true }),
