...
export function K8sClusterTerminal({
  cluster,
  onExit,
  onReady,
  onError,
  ...
  useEffect(() => {
    ...
    void (async () => {
      ...
      try {
        ...
        const info = await k8sKubectlClusterShellStart(cluster, cols, rows);
        if (disposed) {
    ...
    <div className="k8s-terminal-shell-wrap">
      ...
      {menu ? (
        <K8sSelectionContextMenu
          ...
          y={menu.y}
          text={menu.text}
          testIdPrefix="k8s-cluster-terminal"
