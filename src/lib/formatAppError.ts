...
const MESSAGE_TO_KEY: Array<{ match: RegExp | string; key: string }> = [
  ...
  { match: /^ERR_GIT_BASH_REQUIRED\b/, key: "errors:ERR_GIT_BASH_REQUIRED" },
  ...
  { match: /未检测到 Git Bash/, key: "errors:gitBashRequired" },
  { match: /本地终端需要 Git Bash/, key: "errors:gitBashRequiredForFind" },
  ...
  { match: /本地终端不支持重新连接/, key: "errors:localCannotReconnect" },
  ...
  { match: /本地 find 不可用/, key: "errors:findLocalUnavailable" },
